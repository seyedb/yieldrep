...
def test_load_config_reads_project_paths() -> None:
    ...
    assert config.residual_rv_representation_regime_table_path == Path(
        "reports/tables/residual_rv_representation_regime.csv"
    )
    assert config.residual_rv_representation_regime_scorecard_table_path == Path(
        "reports/tables/residual_rv_representation_regime_scorecard.csv"
    )
    assert config.residual_rv_representation_regime_findings_table_path == Path(
        "reports/tables/residual_rv_representation_regime_findings.csv"
    )
    assert config.residual_rv_macro_benchmark_audit_table_path == Path(
        "reports/tables/residual_rv_macro_benchmark_audit.csv"
    )
